...
const ListaUsuarios = ({ esAdmin }) => {
  ...
  const usuariosFiltrados = usuarios.filter(u => {
    const nombre = u.name?.toLowerCase().includes(filtros.nombre.toLowerCase())
    const email = u.email?.toLowerCase().includes(filtros.email.toLowerCase())
    const rol = filtros.rol === '' || u.role === filtros.rol
